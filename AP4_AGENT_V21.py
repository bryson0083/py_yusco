...
sear_str = 'SEAR BC5$LOG:TMP_LOG.TXT "UT_NET_MBX_AST:  MSGTYPE =     30"\r'

#for test
#dt2 = "10-JAN-2017 08"
#sear_str = 'SEAR BC5$LOG:BC5_A4_CMU.0110 "UT_NET_MBX_AST:  MSGTYPE =     30"\r'
...
while True:
	...
	#取出訊息中日期時間部分(d-M-Y HH)
	t = line_str.split(",")
	t = str(t[0].strip()).split(":")
	str_tmp_dt = str(t[0])
...
print("目前這一小時錯誤次數=" + str(cnt))
file.write("目前這一小時錯誤次數=" + str(cnt) + "\n")
